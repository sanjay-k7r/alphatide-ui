...
export function MarketMetricCard({ metric }: MarketMetricCardProps) {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1.5 rounded-md border border-border/40 bg-card/50 px-4 py-3 transition-colors hover:border-border/60">
      <div className="text-xs font-semibold uppercase tracking-[0.24em] text-muted-foreground">
        {ticker}
      </div>
      <div className="tabular-nums text-lg font-semibold tracking-tight text-foreground">
